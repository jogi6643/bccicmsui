...
function initialize() {
    var input = document.getElementById('playlistlocationsearch');
    var autocomplete = new google.maps.places.Autocomplete(input);

    autocomplete.addListener('place_changed', function() {
        var place = autocomplete.getPlace();
        $('#latitudeplaylist').val(place.geometry['location'].lat());
        $('#longitudeplaylist').val(place.geometry['location'].lng());
