...
function initialize() {
    var input = document.getElementById('documentslocationsearch');
    var autocomplete = new google.maps.places.Autocomplete(input);

    autocomplete.addListener('place_changed', function() {
        var place = autocomplete.getPlace();
        $('#latitudedocuments').val(place.geometry['location'].lat());
        $('#longitudedocuments').val(place.geometry['location'].lng());
