...
$(document).ready(function () {
    ...
    $("#delete_icon").click(function () {
        ...
        {
            alert('Please Select atleast one bios!!');
            return false;
        }
...
function initialize() {
    var input = document.getElementById('bioslocationsearch');
    var autocomplete = new google.maps.places.Autocomplete(input);

    autocomplete.addListener('place_changed', function() {
        var place = autocomplete.getPlace();
        $('#latitudebios').val(place.geometry['location'].lat());
        $('#longitudebios').val(place.geometry['location'].lng());
