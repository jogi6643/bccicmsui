...
@section('epic_content')
    ...
    <div class="row bg-title">
        ...
        <div class="alert alert-success" style="display: none" id="delete_msg">Document have been deleted successfully.</div>
        <div class="alert alert-danger" style="display: none" id="un_delete_msg"> Unable to delete document</div>
                ...
                <div class="row content-search-header">
                    ...
                    <section class="col-md-7 col-sm-12">
                        <div class="form-inline">
                            ...
                            <div class="col-md-3">
                                <a class="btn btn--toggle-filter" href="{{ url('getdocument') }}" role="button">Clear</a>
            ...
            <div class="card" data-content-list="data.photolist">
                <div class="results">
                    ...
                    <div class="border-bottom">
                        <h2 class="show-data-pa showing_page_data">Showing {{ $documentlist['from'] }} -
                            {{ $documentlist['to'] }} of {{ $documentlist['total'] }} results</h2>
                        <div class="add-new-button">
                            <a class="recent-content__add btn primary medium" href="{{ url('uploadcontent/documents') }}"><i
                                    class="mdi mdi-plus"></i>Add New Document</a>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="Allfilter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
                ...
                <div class="modal-content" style="width: 60%; margin: 0 auto;">
                    ...
                    <div class="row">
                        <div class="col-md-7 seperator">
                            <div class="row">
                                <div class="col-md-4">
                                    <label>Filter by language</label>
                                    <select class="selectpicker applybtn FilterBylanguage secondLng" multiple
                                ...
                                <div class="col-md-4">
                                    <label>Filter by status</label>
                                    <select class="selectpicker applybtn FilterByStatus secondStatus" multiple
                                        data-actions-box="true">
                                        <option value="published">Published</option>
                                        <option value="in_draft">In Draft</option>
                                        <option value="in_review">In Review</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="filter_by_source[]" class="selectpicker filter_by_source" multiple
                                        data-actions-box="true">
                    ...
                    <div class="reference-search">
                        ...
                        <div class="reference-search__select-container ">
                            ...
                            <select class="form-control selectpicker referencesResponse" name="ref[]" id="browsers"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" style="width: 60%; margin: 0 auto;">
                                    ...
                                    <select class="form-control selectpicker" id="browsers" data-live-search="true"
                                        multiple data-actions-box="true" data-live-search="true" data-show-subtext="true">
                                        <option>
                                            <h2>India’s squad for WTC Final and Test series against England announced</h2>
                                            <span class="lan">English | Last updated 31/08/2021</span> <span
                                                class='id'>ID: 154375</span>
                                        </option>
                                        <option>
                                            <h2>India’s squad for WTC Final and Test series against England announced</h2>
                                            <span class="lan">English | Last updated 31/08/2021</span> <span
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 100%; margin: 0 auto;">
            <div class="modal-header">
                    ...
                    <a class="recent-content__add btn primary medium rightbtn" id="edit_document" href="">Edit Detail</a>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.data) {
                            ...
                            var edit_url= "{{ url('getdocumentById') }}/"+ res.data.ID;
                            ...
                            var pdate = res.data.publishTo ? res.data.publishTo : res.data.publishFrom;
                            if(pdate ==null || pdate== ""){
                                publishdate = "N/A";
                            }
                            else{
