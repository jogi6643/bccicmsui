...
@if($status == true )
@foreach($playlist['payload']['data'] as $photo)
<li class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
    ...
    <div class="info">
        ...
        <dl class="metadata">
            ...
            {{ !empty($photo['publishFrom']) ? \Carbon\Carbon::parse($photo['publishFrom'] ?? '')->format('d M Y H:m') : '' }}
            </dd>
        ...
        <ul class="button_edit">
            ...
            <li>
                <a class="view" title="" data-toggle="tooltip" href="{{url('editplaylists')}}/{{ isset($photo['ID'])? $photo['ID'] : $photo['id']}}" data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
            </li>
