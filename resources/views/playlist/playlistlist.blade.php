...
@section('epic_content')
    ...
    <div class="row bg-title">
        ...
        <div class="alert alert-success" style="display: none" id="delete_msg">Playlist have been deleted successfully.</div>
        <div class="alert alert-danger" style="display: none" id="un_delete_msg"> Unable to delete Playlist</div>
                ...
                <div class="row content-search-header">
                    ...
                    <section class="col-md-7 col-sm-12">
                        <div class="form-inline">
                            ...
                            <div class="col-md-3">
                                <a class="btn btn--toggle-filter" href="{{ url('playlists') }}" role="button">Clear</a>
            ...
            <div class="card" data-content-list="data.photolist">
                <div class="results">
                    ...
                    <div class="border-bottom">
                        <h2 class="show-data-pa showing_page_data">Showing {{ $playlist['from'] }} -
                            {{ $playlist['to'] }} of {{ $playlist['total'] }} results</h2>
                        <div class="add-new-button">
                            <a class="recent-content__add btn primary medium" href="{{ url('uploadcontent/playlists') }}"><i
                                    class="mdi mdi-plus"></i>Add New Playlist</a>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="Viewpage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 100%; margin: 0 auto;">
                <div class="modal-header">
                    <h2 class="Preview-title">Preview playlists</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <section>
                            <div class="row">
                                ...
                                <div class="form-group text-center">
                                    <label for="wfirstName2" class="pdlt"> Cover Photo</label>
                                    <img src="" id="image_url" class="photo-show" name="cover">
                                </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.data) {
                            ...
                            $('#publishTo').html(res.data.current_status);
                            $('#author').html(res.data.author);
                            $('#location').html(res.data.location);
                            $('#content').html(res.data.body);
                            var image_url = res.data.cover ? res.data.cover : '/img/no-image.png';
