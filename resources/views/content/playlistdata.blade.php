        ...
        <div class="filter-wrapper filter-wrapper--content u-flex--fill col-md-8">
            ...
            <div class="filter">
                ...
                <ul>
                    ...
                    <li class="btn primary "><a href="{{url('playlists')}}" ><i class="mdi mdi-apps"></i></a></li>
                    <li class="btn primary2 active" data-icon="list">
                        <a href="{{url('playlistdata')}}" ><i class="mdi mdi-table"></i></a>
        ...
        <li class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
            ...
            <div class="info">
                ...
                <ul class="button_edit">
                    ...
                    <li>
                    <a class="view" title="" data-toggle="tooltip" href="{{url('editplaylists')}}/{{$video['ID']}}"data-original-title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                    </li>
                    <li>
        ...
        <ul class="pagination right">
              @foreach($videoslist['link'] as $link)
                  <li class="page-item {{($link['active'] == 1 ? 'active' : '')}}">
                      <a class="page-link" href="{{url('/playlistdata')}}/{!! $link['label'] !!}">
                          {!! $link['label'] !!}
                      </a>
                  </li>
              @endforeach            
