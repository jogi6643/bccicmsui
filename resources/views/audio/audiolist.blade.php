...
@section('epic_content')
    ...
    <div class="row bg-title">
        ...
        <div class="alert alert-success" style="display: none" id="delete_msg">Audio have been deleted successfully.</div>
        <div class="alert alert-danger" style="display: none" id="un_delete_msg"> Unable to delete Audio</div>
                ...
                <div class="row content-search-header">
                    ...
                    <section class="col-md-7 col-sm-12">
                        <div class="form-inline">
                            ...
                            <div class="col-md-3">
                                <a class="btn btn--toggle-filter" href="{{ url('getAudioList') }}" role="button">Clear</a>
            ...
            <div class="card" data-content-list="data.photolist">
                <div class="results">
                    ...
                    <div class="border-bottom">
                        <h2 class="show-data-pa showing_page_data">Showing {{ $audiolist['from'] }} -
                            {{ $audiolist['to'] }} of {{ $audiolist['total'] }} results</h2>
                        <div class="add-new-button">
                            <a class="recent-content__add btn primary medium" href="{{ url('uploadcontent/audio') }}"><i
    ...
    <div class="modal fade" id="Viewpage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 100%; margin: 0 auto;">
                <div class="modal-header">
                    <h2 class="Preview-title">Preview Audio</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script src="{{ asset('js/audio/audiolist.js') }}" type="text/javascript"></script>
