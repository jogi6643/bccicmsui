...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Vod Content</li>
        </ol>
    </div>
    <!-- /.breadcrumb -->
</div>
...
<div class="modal-dialog modal-lg" style="width:85%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h4 class="card-title">VOD content</h4>
        ...
        <div class="col-md-6">
              <h3>Select Platform</h3>
                    <label for="shortDescription3">Platform</label>
                      <!-- <label class="control-label"></label> -->
                        <select class="selectpicker" multiple data-live-search="false">
                                    <!-- <option>select country</option> -->
                            <option value="AF">BCCI Domestic</option>
                            <option value="AX">BCCI International</option>
                            <option value="AL">IPL</option>
                        </select>  
