...
<div class="border-bottom">
    ...
    <div class="add-new-button">
        <a class="recent-content__add btn primary medium" href="addnewarticle"><i class="mdi mdi-plus"></i>Add new Audio</a>
    </div>
 </div>   
               ...
               if(ref!=undefined && ref!=null)
            {
                $.ajax({
                     ...
                     success: function (res){
                       $('.refclassaduio').selectpicker('refresh');
