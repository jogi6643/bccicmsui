...
<div class="row">
  ...
  <div class="content_text"><p>Manage Playlist</p></div>
...
<div class="border-bottom">
    ...
    <div class="add-new-button">
        <a class="recent-content__add btn primary medium" href="addnewarticle"><i class="mdi mdi-plus"></i>Add new Playlist</a>
    </div>
 </div>   
