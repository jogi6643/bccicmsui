...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            <li><a href="{{url('/')}}">BCCI International ( Menu Item )</a></li>
            <li class="active"></li>
        </ol>
    </div>
    <!-- /.breadcrumb -->
...
<div class="container-fluid">
          <div class="row">    
              <div class="card margin-top">
                   ...
                   <!-- 3 columns -->
                       <div class="col-md-12"><h3>BCCI International ( Menu Item )</h3></div>
                        ...
                        <div class="row">
                          <div class="center-box-div-">  
                            <div class="col-md-3 col-xs-12 col-sm-6">
                             <a href="othermenucontentinternal">   
                              <div class="box draggable">
                                <h3>Virtual Recreation Module itegration</h3>
                              </div>
                             </a> 
                            </div>
                            ...
                            <div class="col-md-3 col-xs-12 col-sm-6">
                             <a href="othermenucontentinternal">   
                              <div class="box draggable">
                                <h3>Coaching Module Integration</h3>
                              </div>
                             </a> 
                            </div>
                          </div>  
