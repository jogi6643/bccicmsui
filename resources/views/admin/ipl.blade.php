...
<div class="row bg-title" style="overflow-x: hidden;">
    <!-- .page title -->
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="{{url('/')}}">IPL ( Menu Item )</a></li>
            <li class="active"></li>
        </ol>
    </div>
    <!-- /.breadcrumb -->
...
<div class="container-fluid" style="overflow-x: hidden;">
    <div class="row">    
        <div class="card margin-top">
           <!-- 3 columns -->
            <div class="col-md-12"><h3>IPL ( Menu Item )</h3></div>
                ...
                <div class="row">
                  <div class="center-box-div-">  
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-6">
                     <a href="othermenucontentinternal">   
                      <div class="box draggable">
                        <h3>Auction Management Module</h3>
                      </div>
                     </a> 
                    </div>
                  </div>  
