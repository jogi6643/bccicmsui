    ...
    <!-- <input type="checkbox" id="select_all" name="select_all" value="Select all"> -->
        ...
        <div class="col-md-6">
           ...
           <div class="col-md-12 text-left">
            <button type="button" class="btn btn-primary" href="exampleModalLong"  data-toggle="modal" data-target="#exampleModalLong">Submit</button>
           </div> 
            
                <!-- Step 4 -->
    
        <section id="steps-uid-0-p-7" role="tabpanel" aria-labelledby="steps-uid-0-h-7" class="body" aria-hidden="true" style="display: none;">
