                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="text-align:right;">
                                        <button type="button" title="Edit" data-id="5" class="edit-list btn btn-info btn-outline btn-circle"><a href="edittray"><i class="ti-pencil-alt"></i></a></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="text-align:right;">
                                        <button type="button" title="Edit" data-id="7" class="edit-list btn btn-info btn-outline btn-circle"><a href="edittray"><i class="ti-pencil-alt"></i></a></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="text-align:right;">
                                        <button type="button" title="Edit" data-id="8" class="edit-list btn btn-info btn-outline btn-circle"><a href="edittray"><i class="ti-pencil-alt"></i></a></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="text-align:right;">
                                        <button type="button" title="Edit" data-id="9" class="edit-list btn btn-info btn-outline btn-circle"><a href="edittray"><i class="ti-pencil-alt"></i></a></button>
            ...
            <div class="white-box row">
                ...
                <form class="form-horizontal" method="post" action="https://livecms.epicon.in/lists" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-info btn-lg tray-btn" href="exampleModalLong"  data-toggle="modal" data-target="#exampleModalLong">Submit</button>
                                <button type="submit" class="btn btn-info btn-lg tray-btn">Cancel</button>
                            </div>
                        </div>
                </form>
            </div>
