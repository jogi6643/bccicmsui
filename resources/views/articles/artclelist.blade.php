...
@section('epic_content')
    ...
    <div class="row bg-title">
        ...
        <div class="alert alert-success" style="display: none" id="delete_msg">Articles have been deleted successfully.</div>
        <div class="alert alert-danger" style="display: none" id="un_delete_msg"> Unable to delete Articles</div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{ url('#') }}">Content Management</a></li>
                <li class="active">Aticles</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
                ...
                <div class="row content-search-header">
                    ...
                    <section class="col-md-7 col-sm-12">
                        <div class="form-inline">
                            ...
                            <div class="col-md-3">
                                <a class="btn btn--toggle-filter" href="{{ url('articles') }}" role="button">Clear</a>
            ...
            <div class="card" data-content-list="data.articleList">
                <div class="results">
                    ...
                    <div class="border-bottom">
                        <h2 class="show-data-pa showing_page_data">Showing {{ $articlelist['from'] }} -
                            {{ $articlelist['to'] }} of {{ $articlelist['total'] }} results</h2>
                        <div class="add-new-button">
                            <a class="recent-content__add btn primary medium" href="{{ url('uploadcontent/articles') }}"><i
    ...
    <form method="POST" action="{{ route('deletearticles') }}" name="user_form" class="deleteSingleUser"
        ...
        {{ csrf_field() }}
        <input type="hidden" value="" name="single_article_id" id="single_article_id">
          <input type="hidden" value="tableview" name="articleview">
    </form>
                    ...
                    <form data-parsley-validate action="{{ route('addArticle') }}" name="article_form" id="article_form"
                        ...
                        <section>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="pdlt" for="wfirstName2">
                                            Publish Date: 
                                            <span class="date" id="publishFrom"></span>
                                            Expiry Date: 
                                ...
                                <div class="col-md-6">    
                                    <div class="form-group">
                                        <label for="wlastName2" class="pdlt description">Article Photo </label>
                                        <img src="" id="image_url" name="image_url" alt="Trulli" class="art-img">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group description">
                                        <label for="wlastName2" class="pdlt description">Content Article </label>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.data) {
                            ...
                            $('#publishFrom').html(res.data.publishFrom);
                            $('#publishTo').html(res.data.publishTo);
                            var author = res.data.author ? res.data.author :'---';
                            $('#author').html(author);
